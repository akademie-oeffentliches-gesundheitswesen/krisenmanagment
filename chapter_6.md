...
zur Verfügung. Sie decken die folgenden Themengebiete ab:
  ...
  - Gefährdungsbeurteilung (z.B. Gefährdungsbeurteilung, Einstufung in
    Risikogruppen)
  ...
  - Beschlüsse des ABAS zu Anforderungen bei Tätigkeiten mit
    ...
    **FOTO: Infektionsschutzset vs. Gebläseschutz**
    ...
    Die Atemwege werden durch Partikelfiltierende Masken geschützt (FFP
    = Filtering Face Piece). Die Dichtigkeit wird nach DIN EN 149:2001
  ...
  - FFP-3 höchstnes 2% Gesamtleckage
    ...
    die wichtige Hinweise zur Benutzung von Atemschutzgeräten
    (<https://publikationen.dguv.de/regelwerk/regeln/1011/benutzung-von-atemschutzgeraeten>)
    zusammengestellt.
    
    ### **Augenschutz**
    
    Bei der Auswahl von Augenschutz im Rahmen eines
    Infektionsschutzsetzs ist darauf zu achten, dass er mit den anderen
    Komponenten zusammen passt. Besonders kritisch ist der Übergang von
    Atemschutzmaske und Schutzbrille. Bei Gebläseschutzanzügen ist der
    Augenschutz integriert. Je nach Risikobewertung kann eine Vollbrille
    notwendig sein, die rundum geschlossen, ungelüftet und beschlagsfrei
    ist. Wenn keine Gefahr einer Aerosolbildung besteht, kann auch
    Gesichtsvisier genutzt werden. Die Prüfkriterien sind in der EN 166
    festgelegt. Entsprechend dieser Norm sollte die Schutzbrille die
    Rahmenkennzeichnung 5 aufweisen.
...
Szenarien wird der Bedarf beispielhaft dargestellt: "Estimated Personal
Protective Equipment (PPE) Needed for Healthcare Facility"
...
> Unter epidemiologischer Überwachung / Surveillane wird "die
> fortlaufende systematische Sammlung, Analyse, Bewertung und
...
> der Früherkennung und Verhinderung der Weiterverbreitung von
> Infektionen
> 
...
> festgeschrieben. Dort sind festgelegt die meldepflichtigen
> Krankheiten, Krankheitserreger sowie zur Meldung verpflichtete
> Personen sowie die Meldewege vom Gesundheitsamt über Landesbehörden
> bis zur Bundesbehörde und der Weltgesunheitsorgansiation. In
> Krisenfällen ist das BMG durch §15 ermächtigt, mittels
> Rechtsverordnung entsprechend der epideiologischen Lage, die
...
ist auch auf der Internetseite des RKI einzusehen. Bei der Desinfektion
werden thermische, chemische und sonstige Verfahren unterschieden. Bei
der Auswahl eines geeingeten Desinfektionsmittels ist es notwendig, die
Wirkungsbereiche zu beachten. Diese sind in der Desinfektionsmittelliste
- hier vereinfacht dargestellt - unterschieden nach:
...
voraussetzt, sind in einer Empfehlung der [Kommission für
...
die [personellen und organisatorischen Voraussetzungen zur Prävention
nosokomialer
Infektionen](https://www.rki.de/DE/Content/Infekt/Krankenhaushygiene/Kommission/Downloads/Rili_Hygmanagement.pdf?__blob=publicationFile "https://www.rki.de/DE/Content/Infekt/Krankenhaushygiene/Kommission/Downloads/Rili_Hygmanagement.pdf?__blob=publicationFile")
beschrieben.
...
das durch eine unmittelbar nach der Infektion eingeleitete Therapie der
Ausbruch einer Krankheit verhindert wird.

Beispiele für Krankheiten, die mit antibiotischen
...
Aber auch einige Viruserkrankungen können im Rahmen eines individuellen
Heilversuchs einer PEP zugänglich sein, z.B.
...
Risikobewertungen vornehmen. Dazu gehört die folgenden Fragen zu klären:
  ...
  - Ist eine eigene Bevorratung von Medikamenten sinnvoll?
...
zeitweilige **Absonderung gesunder Personen**, die verdächtig sind, sich
mit einer kontagiösen Krankheit angesteckt zu haben
(Ansteckungsverdächtige). Nach § 30 Infektionsschutzgesetz handelt es
sich um eine behördlich angeordnete Absonderungsmaßnahmeim, die als
obligatorische Maßnahme für Lungenpest und übertragbare Hämorrhagische
Fieber festgelegt ist.

Ziel ist, eine Weiterverbreitung der Krankheit bestmöglich zu reduzieren
(siehe:
...
In Abgrenzung zur Quarantäne sollte die **Absonderung einschlägig
Erkrankter** künftig als **Isolierung** bezeichnet werden.

### Praktische Aspekte der Quarantäne

Erfahrungen von Ausbrüchen in den letzten Jahren, bei denen Quarantäne
angeordnet wurde, zeigen, dass den Betroffenen häufig der Hintergrund
für die Sinnhaftigkeit der Maßnahme fehlte und sie teilweise lediglich
als „Arbeitsverbot“ verstanden wurde oder dass sie zwar die Wohnung
nicht verlassen sollen und daher im Gegenzug Besuch einladen.
...
Personen in der selben Wohnung aufhalten die nicht unter Quarantäne
stehe,. Hierzu gehören die gute Händehygiene sowie das gegenseitige
Abstandhalten. Insbesondere bei Familien mit kleinen Kindern kann dies
eine große Herausforderung darstellen.

Eine besondere Herausforderung kann auch die Versorgung von Personen
darstellen, die unter Quarantäne stehen und keine Nachbarn oder
Angehörige haben, die sie mit Lebensmitteln versorgen können. Hierzu
sollte das Gesundheitsamt eine Liste mit Unterstützungsangeboten
vorbereiten, z.B. Lieferdienste von Lebensmittelgeschäften oder
Apotheken.
...
dass die Quarantäne-Anordnung nicht eingehalten oder abgebrochen wird.
...
Die Feuerwehr-Dienstvorschrift FwDV 500 „Einheiten im ABC – Einsatz“
(2012)
...
Rettungsdienstes erstellen hierzu Hygienepläne. Diese sollte in
Zusammenarbeit mit dem ÖGD geplant werden.
...
Dekontamination zugeführt werden (z.B. chemisch oder thermisch). Die
dekontaminierte Person ist ansteckungsverdächtig, aber nicht infektiös.
...
können und welche Erkrankungsfälle in welcher Anzahl sicher
...
Deutschland Sonderfahrzeuge (Infektionsrettungswagen, I-RTW), speziell
...
übernommen wird, dass diese nach Dekontamination zuverlässig arbeiten.
...
SIT/HIT sind entsprechend in den Kompetenz- und Behand­lungs­zentren für
Krankheiten durch hoch­patho­gene Erreger
...
Krankheiten durch hochpathogene Erreger" beim Robert Koch-Institut
beraten zu lassen.
...
sollte mit dem Labor abgestimmt werden, welche Probe wie und in welcher
Menge genommen werden soll. Zudem muss sichergestellt sein, dass das
Labor Umweltproben bearbeiten kann. Wird ein (bio-)terroristischer
...
Abstimmung mit den zuständigen Polizeibehörden notwendig.
...
nicht selber durchführen will, mit den örtlichen Feuerwehren im Vorfeld
Absprachen treffen. Weitere Informationen mit Empfehlungen für die
Probenahme zur Gefahrenabwehr im Bevölkerungsschutz hat das BBK
veröffentlicht
...
Straße, Eisenbahn und Binnenschifffahrt (GGVSEB §18,
...
Leitung der versendenden Institution und damit z.B. der Leiter/in des
Gesundheitsamtes.

Zum korrekten Versenden gehören (ausführliche Erläuterung im Leitfaden
der Weltgesundheitsorgansiation "Guidance on regulations for
theTransport of Infectious Substances",
...
Biologische Proben werden noch einmal unterteilt in:
  ...
  - einer starren Außenverpackung
    ...
    **EINFÜGEN: GRAFIK: Klasse - Kategorie - Verpackungsvorschrift**
    
    Eine ausführliche Beschreibung der Verpackung findet sich im
    WHO-Leitfaden [Guidance on regulations fortheTransport of Infectious
    Substances](https://www.who.int/csr/resources/publications/biosafety/WHO_HSE_EPR_2008_10.pdf?ua=1 "https://www.who.int/csr/resources/publications/biosafety/WHO_HSE_EPR_2008_10.pdf?ua=1")
    .
...
Im Falle der Primärproben bei einem bioterroristischen Anfall oder bei
einer akut lebensbedrohlichen Erkrankung, bei nicht auf ein offiziell
für den Gefahrguttransport gekennzeichnet Fahrzeug mit entsprechend
geschulten Fahrer zurückgegriffen werden kann, ist eine
...
Händehygiene, eine Husten- und Nies-Etikette sowie Abstand halten (1-2
m).
...
Bei Großveranstaltungen wie Messen, Rockkonzerte, Sportveranstaltungen
können als Kriterien für die Beschränkung herangezogen werden:

• Besteht die Möglichkeit Abstandsregelungen und sonstige
Hygienemaßnahmen einzuführen oder kann die Teilnehmerzahl so reduziert
werden, dass dieses möglich wird?
...
(Robert Koch-Institut: Allgemeine Prinzipien der Risikoeinschä tzung
und Handlungsempfehlung für Großveranstaltungen, 28.2.2020
...
seuchenhygienische Maßnahmen (s. entsprechendes Kapitel) so lange
hinauszuzögern, bis Impfstoffe oder Medikamente zur Verfügung stehen.
Für den Fall sollten Konzepte erarbeitet werden, wie die Medikamente
oder Impfstoffe am schnellsten und sichersten der Bevölkerung zu
Verfügung gestellt werden können. Konozepte hierzu wurden
beispielsweise im Rahmen der Vorsorge eines Ausbruchs von humanen
Pockenviren deutschlandweit erstellt.
